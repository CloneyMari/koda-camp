...
ActiveRecord::Schema[7.0].define(version: 2023_07_13_080430) do
  ...
  create_table "post_mood_ships", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "post_id"
    t.bigint "mood_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["mood_id"], name: "index_post_mood_ships_on_mood_id"
    t.index ["post_id"], name: "index_post_mood_ships_on_post_id"
  end
